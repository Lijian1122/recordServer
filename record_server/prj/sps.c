...
int main()
{
	BYTE buff[23] = {0x67, 0x42, 0xC0, 0x1E, 0xDA ,0x02, 0x80, 0xF6, 0x84, 0x00 ,0x00,
		0x03, 0x00, 0x04, 0x00, 0x00, 0x03, 0x00, 0x7A, 0x3C ,0x58, 0xBA, 0x80};

	int width = 0;
	int height = 0;
	int fps = 0;
	bool ok = h264_decode_sps(buff, 23, width, height, fps);

	printf("宽：%d  高：%d  pps: %d\n", width, height, fps);
