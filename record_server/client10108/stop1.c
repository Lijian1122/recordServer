...
//static const char *url = "http://localhost:8000/stopRecord/recodID=111111";

static const char *url  =  "http://localhost:8000/live/record?liveId=FreeManCamera001&type=1";
